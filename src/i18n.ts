...
const en = {
  ...
  general: "General",
  language: "Language",
  languageDesc: "Automatic follows Obsidian's language. Restart Obsidian to apply changes.",
...
const de = {
  ...en,
  general: "Allgemein", language: "Sprache", languageDesc: "Automatisch folgt der Sprache von Obsidian. Starte Obsidian neu, um Änderungen anzuwenden.", automaticObsidian: "Automatisch (Obsidian)",
...
const es = {
  ...en,
  general: "General", language: "Idioma", languageDesc: "Automático sigue el idioma de Obsidian. Reinicia Obsidian para aplicar los cambios.", automaticObsidian: "Automático (Obsidian)",
...
const fr = {
  ...en,
  general: "Général", language: "Langue", languageDesc: "Le mode automatique suit la langue d’Obsidian. Redémarrez Obsidian pour appliquer les modifications.", automaticObsidian: "Automatique (Obsidian)",
...
const it = {
  ...en,
  general: "Generale", language: "Lingua", languageDesc: "La modalità automatica segue la lingua di Obsidian. Riavvia Obsidian per applicare le modifiche.", automaticObsidian: "Automatico (Obsidian)",
...
const ptBR = {
  ...en,
  general: "Geral", language: "Idioma", languageDesc: "O modo automático segue o idioma do Obsidian. Reinicie o Obsidian para aplicar as alterações.", automaticObsidian: "Automático (Obsidian)",
...
const nl = {
  ...en,
  general: "Algemeen", language: "Taal", languageDesc: "Automatisch volgt de taal van Obsidian. Start Obsidian opnieuw om wijzigingen toe te passen.", automaticObsidian: "Automatisch (Obsidian)",
...
const pl = {
  ...en,
  general: "Ogólne", language: "Język", languageDesc: "Tryb automatyczny używa języka Obsidian. Uruchom ponownie Obsidian, aby zastosować zmiany.", automaticObsidian: "Automatycznie (Obsidian)",
...
const hr = {
  ...en,
  general: "Općenito", language: "Jezik", languageDesc: "Automatski način prati jezik Obsidiana. Ponovno pokrenite Obsidian kako biste primijenili promjene.", automaticObsidian: "Automatski (Obsidian)",
...
const zhCN = {
  ...en,
  general: "常规", language: "语言", languageDesc: "自动模式跟随 Obsidian 的语言。重启 Obsidian 后更改才会生效。", automaticObsidian: "自动（Obsidian）",
